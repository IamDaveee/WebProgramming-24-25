...
//}
let reverse=text.toLocaleLowerCase().split("").reverse().join("")
console.log(reverse)
let allitas=(text===reverse)
console.log(`Palndróm-e? ${allitas ? 'A 2 szöveg egyezik':'A 2 szöveg nem egyezik'}`)
debugger
